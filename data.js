window.__STAR_PAGE_DATA__ = {
  ...
  "generatedAt": "2026-04-08T09:48:16",
  "total": 582,
  "categories": {
  ...
  "items": [
    ...
    },
    {
      ...
      "description": "项目核心面向 Agent、MCP、Skill、AI 工作流或 LLM 工具链，而不是单纯的网站模板或运维脚本。",
      "category": "AI/Agents/Skills",
      "topics": [
        "agent",
        "automation",
    ...
    },
    {
      ...
      "description": "Wherever your AI supports skills, VibeSkills works. 340+ governed skills spanning coding, research, automation & creative work.",
      "category": "AI/Agents/Skills",
      "topics": [
        "ai-agents",
        "ai-workflow",
    ...
    },
    {
      ...
      "description": "主要功能围绕 Telegram/微信/Discord 等消息平台的机器人、转发、通知、监听或互动桥接展开。",
      "category": "Bot/消息桥接",
      "topics": [
        "wechat",
        "pyqt",
    ...
    },
    {
      ...
      "description": "README 明确是 Telegram 电商机器人系统，虽然售卖数字商品，但交互载体是机器人。",
      "category": "Bot/消息桥接",
      "topics": [],
      "language": "Go",
      "stars": 64,
    ...
    },
    {
      ...
      "description": "项目价值点正是把 Gateway 重启事件通知到 Telegram/Discord/Slack 等消息渠道。",
      "category": "Bot/消息桥接",
      "topics": [],
      "language": "Shell",
      "stars": 58,
    ...
    },
    {
      ...
      "description": "README 直接写明它是 Telegram 消息转发与频道/群组导出备份工具。",
      "category": "Bot/消息桥接",
      "topics": [],
      "language": "Python",
      "stars": 13,
    ...
    },
    {
      ...
      "description": "仓库面向视频聚合播放，本质是媒体站点/播放器。",
      "category": "媒体下载/存储",
      "topics": [],
      "language": "TypeScript",
      "stars": 1900,
    ...
    },
    {
      ...
      "description": "核心围绕视频/音频/图片/网盘/文件的下载、播放、同步、分享、索引、生成或存储管理。",
      "category": "媒体下载/存储",
      "topics": [
        "jsdelivr",
        "jsdelivr-cdn",
    ...
    },
    {
      ...
      "description": "⏰ 60s API 免费接口。每天 60 秒看世界、奥运会奖牌榜 🏅、小红书/B站/微博/抖音/知乎热搜、金价、油价、天气、翻译、壁纸、Epic 游戏、二维码、猫眼票房｜一系列 高质量、开源、可靠、全球 CDN 加速 的开放 API 集合，支持 Docker / Deno / Bun / Cloudflare Workers / Node.js 部署",
      "category": "开发工具/自动化",
      "topics": [
        "60s",
        "bilibili",
    ...
    },
    {
      ...
      "description": "它更像开发者工具、自动化框架、插件/扩展、RPA 或单功能效率工具，而不是独立网站或基础设施平台。",
      "category": "开发工具/自动化",
      "topics": [],
      "language": "Python",
      "stars": 2667,
    ...
    },
    {
      ...
      "description": "README 显示它是多平台账号自动注册与管理系统，Cloudflare 邮箱只是可选组件，不是项目主轴。",
      "category": "开发工具/自动化",
      "topics": [],
      "language": "Python",
      "stars": 1492,
    ...
    },
    {
      ...
      "description": "README 说明它是把图片/PDF OCR 转为可编辑 PPT 的桌面工具。",
      "category": "开发工具/自动化",
      "topics": [],
      "language": "Python",
      "stars": 446,
    ...
    },
    {
      ...
      "description": "这里的 bot 指交易自动化程序，不属于消息桥接。",
      "category": "开发工具/自动化",
      "topics": [],
      "language": "Python",
      "stars": 88,
    ...
    },
    {
      ...
      "description": "README 说明它是对 Discourse 站点做自动互动/刷站的脚本，而不是 AI API 网关。",
      "category": "开发工具/自动化",
      "topics": [],
      "language": "Python",
      "stars": 4,
    ...
    },
    {
      ...
      "description": "仓库主要交付的是博客/CMS/导航/社区/主题或面向终端用户的站点业务系统，网站形态比底层技术更核心。",
      "category": "网站/CMS/博客",
      "topics": [],
      "language": "CSS",
      "stars": 821,
    ...
    },
    {
      ...
      "description": "基于 FastAPI 构建的 Grok2API，全面适配 OpenAI 兼容的调用格式，支持流式/非流式对话、图像生成、图像编辑、视频生成、工具调用、语音聊天、一键NSFW、号池并发与自动负载均衡一体化。",
      "category": "逆向2API/AI网关",
      "topics": [
        "grok",
        "grok-imagine",
    ...
    },
    {
      ...
      "description": "README 明确把它定位成统一接入 Claude/OpenAI/Gemini 与 CLI 的 AI 基础设施平台。",
      "category": "逆向2API/AI网关",
      "topics": [],
      "language": "Python",
      "stars": 935,
    ...
    },
    {
      ...
      "description": "项目核心是把模型/客户端/网页能力转成兼容 API，或提供多模型统一网关、代理、中转与账号池能力。",
      "category": "逆向2API/AI网关",
      "topics": [],
      "language": "Go",
      "stars": 563,
    ...
    },
    {
      ...
      "description": "README 说明其本质是把 Augment 的 LLM 数据面端点路由到 BYOK 提供方，属于 AI 接入改写层。",
      "category": "逆向2API/AI网关",
      "topics": [],
      "language": "JavaScript",
      "stars": 342,
    ...
    },
    {
      ...
      "description": "它的职责是同步 GPT-Load 与 New-API 渠道配置，属于 AI 网关生态工具。",
      "category": "逆向2API/AI网关",
      "topics": [],
      "language": "Vue",
      "stars": 71,
    ...
    },
    {
      ...
      "description": "虽然有 Web 界面，但核心是 ChatGPT Team 账号的自动邀请与接入管理，属于 AI 接入层周边。",
      "category": "逆向2API/AI网关",
      "topics": [],
      "language": "HTML",
      "stars": 44,
    ...
    },
    {
      ...
      "description": "README 明确写到它是 AI API transparent proxy service，并增强了模型聚合与智能路由。",
      "category": "逆向2API/AI网关",
      "topics": [],
      "language": "Go",
      "stars": 8,
